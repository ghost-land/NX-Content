        ...
        <div className="flex items-center space-x-4">
          {showLogs && (
            <button
              ...
              className="flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-blue-500/10 text-blue-500 hover:bg-blue-500/20 transition-colors"
            >
          ...
          <a
            ...
            className="flex items-center space-x-2 px-3 py-1.5 rounded-lg hover:bg-muted transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
